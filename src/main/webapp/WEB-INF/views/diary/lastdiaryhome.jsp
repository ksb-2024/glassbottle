...
<head>
	...
	<c:set var='replyMap' value='${replyMap}'/>
	<c:set var='like' value=''/>
	<input type="hidden" name='replyMap' id='replyMap' value='${replyMap}'/>
    <!---  상단 ---->
        ...
        <div class="container">
			...
			<!-- -------END OF STORIES --------- -->
				...
				<c:forEach var='diary' items='${diaryList}'>
					<!--  ------------_FEED 1 ------------- -->
					<c:if test="${diary.getDDELETECHECK() eq 'NO_DELETE'}">
					<div class="feed">
						<div class="head">
							<div class="user">
								<div class="profile-photo">
							...
							<span class="edit"> 
								<c:if test="${diary.getDSHARECHECK() eq 'NO_SHARE'}">
									<i class="uil uil-times" value="${diary.getDID()}" style="cursor:pointer"></i>
								</c:if>
							</span>
						</div>
